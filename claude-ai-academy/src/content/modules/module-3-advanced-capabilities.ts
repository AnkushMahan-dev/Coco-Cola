...
export const module3: Module = {
  ...
  lessons: [
    ...
    // =====================================================================
    {
      ...
      overview: [
        "Claude Cowork is where you hand Claude real work. Anthropic describes it as \"Claude Code for the rest of your work\" - it uses the same agentic engine as Claude Code, but for non-coding knowledge work: research, analysis, document creation and other multi-step tasks. You give it a goal, it works across the files and tools you choose, and you come back to polished work for your review. You'll find it right next to Chat in the Claude app; it needs a paid plan (Pro, Max, Team or Enterprise) and runs on desktop, with web and mobile in beta.",
        "The core idea is 'say what, not how'. You describe the outcome; Claude figures out the steps, shows each one as it works (the files it opens, the tools it uses, the choices it makes), and lets you redirect or stop at any point. It only ever touches the folders and tools you grant, and anything destructive needs your approval. Two capabilities make it powerful for busy teams: it can run scheduled tasks unattended (close your laptop and it keeps going in the cloud), and it splits big jobs into chunks that run in parallel - drafting while it also researches and organizes.",
        "For SAP teams this is a major lever for everything that surrounds the ABAP code: drafting functional specifications from ticket exports, analyzing ATC result spreadsheets, consolidating transport lists, preparing cutover checklists, and turning meeting notes into action plans. These tasks eat hours of developer and consultant time every week. Note the boundary that separates it from Claude Code: Cowork is for document-and-office work on the files and connectors you choose - it does not log into your SAP system or change ABAP in the repository, so it complements Claude Code and your ABAP tools rather than replacing them.",
      ],
      objectives: [
